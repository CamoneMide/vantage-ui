...
*(Note: Use opacity variations of Deep Black, e.g., `rgba(10, 10, 10, 0.6)`, for secondary text, borders, and shadows to maintain chromatic consistency without introducing conflicting gray hues.)*
