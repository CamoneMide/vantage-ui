...
- [ ] **Create mock design system fixtures**: Typed mock data for the Theme Scan results.
...
- [ ] **Create Zustand design system slice**: State management for Theme Scan.
...
- [ ] **Build `DesignTabIdleState` component**: Shown before a scan is triggered.
...
- [ ] **Build `DesignTabScanningState` component**: Animated progress indicator while scanning.
...
- [ ] **Build `ColorPaletteGrid` component**: Displays extracted color swatches.
...
- [ ] **Build `TypographyScaleTable` component**: Displays extracted typography rules.
...
- [ ] **Build `SpacingSystem` component**: Displays spacing scale visually.
...
- [ ] **Build `DesignMdViewer` component**: Inline Markdown viewer for the generated DESIGN.md.
...
- [ ] **Build download action buttons**: File downloads for DESIGN.md and tailwind.config.js.
...
- [ ] **Assemble `DesignTab` and wire into `DesignTab.tsx`**: Replace placeholder from Phase 5.
