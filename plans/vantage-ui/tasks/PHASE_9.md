...
- [x] **Install Sandpack**: Add the `@codesandbox/sandpack-react` dependency.
...
- [x] **Build `SandpackContainer` component**: Core Sandpack integration wrapper.
...
- [x] **Configure Sandpack editor styling**: Apply DESIGN.md aesthetics to the editor and preview panes.
...
- [x] **Build `SandpackToolbar` component**: Action bar above the sandbox.
...
- [x] **Implement live-edit-to-preview updates**: Ensure Sandpack preview updates as user edits.
...
- [x] **Connect Sandpack to extraction result**: Wire the generated code into the sandbox.
...
- [x] **Add loading state for Sandpack initialization**: Sandpack takes a moment to initialize the sandbox iframe.
