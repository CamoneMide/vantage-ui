...
- [ ] **Create mock credits fixtures**: Typed credit balance and transaction data.
...
- [ ] **Build `CreditBalanceCard` component**: Top-level balance overview card.
...
- [ ] **Build low-credit warning banner**: Global warning when balance falls below 5.
...
- [ ] **Build `CreditPackSelector` component**: 3-option credit pack purchase cards.
...
- [ ] **Build `TransactionHistoryTable` component**: Full transaction log.
