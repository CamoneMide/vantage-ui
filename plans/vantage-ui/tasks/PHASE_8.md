...
- [ ] **Create mock extraction fixtures**: Define typed mock data for all extraction states.
...
- [ ] **Create Zustand extraction slice**: State machine for the extraction pipeline.
...
- [ ] **Build mock extraction simulator**: Simulates the 3-step pipeline with timed delays.
...
- [ ] **Build `ExtractionSelectedState` component**: Shown after an element is selected via the inspector.
...
- [ ] **Build `ExtractionProgressState` component**: 3-step animated stepper.
...
- [ ] **Build `ExtractionSuccessState` component**: Shows the Blueprint viewer and transitions to Sandpack.
...
- [ ] **Build `ExtractionErrorState` component**: Specific error messages for each failure type.
