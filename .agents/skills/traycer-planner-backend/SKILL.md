...
A premium project architect and planner designed to bridge the gap between high-level intent and granular backend execution. This skill is meant to be used *after* all frontend implementations have been fully completed and tested.
